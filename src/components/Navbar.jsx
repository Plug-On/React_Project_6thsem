        ...
        <div>
            <nav className="flex justify-between items-center px-15 py-2 bg-gray-100">
                ...
                <ul className="flex justify-center space-x-4">
                    ...
                    <li>
                        <NavLink to='/services' className={({isActive}) => isActive ? "text-blue-500 font-bold overline" : "text-blue-500"}>Services</NavLink>
                    </li>
                    <li>
                        <NavLink to="/contacts" className={({isActive}) => isActive ? "text-blue-500 font-bold overline" : "text-blue-500"}>Contacts</NavLink>
                    </li>
                    <li>
