  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <form className="bg-white shadow-lg rounded-2xl p-8 w-96">
        <h1 className=" pacifico-regular text-center text-3xl font-extrabold text-gray-800 mb-6">Register</h1>
        ...
        <button
          type="submit"
          className="w-full p-3 bg-blue-500 text-white font-bold rounded-lg hover:bg-orange-600 transition duration-300"
        >
          Register
        </button>
